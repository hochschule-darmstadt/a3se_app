...
|---|---|---|---|---|---|---|
| SE-001 | Internal implementation of the Accounting, Reporting, and Human Resources subdomains/modules | These supporting processes remain external to the implementation scope; the project covers only the interfaces through which in-scope modules interact with them | Stakeholder scope direction, 2026-08-01 | [Supporting Business Processes](domains/domains.md) | Revisit only if the project's implementation scope is explicitly expanded | accepted |
