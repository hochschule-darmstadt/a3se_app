...
- Owning bounded context: Travel Product Management
...
4. The system performs the responsibilities owned by Travel Product Management and coordinates required participants.
