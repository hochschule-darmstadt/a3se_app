...
a sufficiently specified and plausible composition.
...
a versioned offer stating whether and until when it can be accepted.

## Minimal guarantee

an incomplete proposal is not represented as orderable.

## Policies and information

Customer, Itinerary, services, Sale Price, validity, conditions, version, availability state.
...
Scenario: Receive a Sales Offer
  Given the Customer has a plausible composition that can be priced
