...
| FR-005 | Customer Interaction SHALL permit a Customer to seek advice, search, review travel information, and obtain plausibility or availability results without registering or signing in. | [UC-001](use-cases/uc-001-seek-travel-advice.md), [UC-005](use-cases/uc-005-obtain-plausible-itinerary.md), [UC-009](use-cases/uc-009-obtain-availability-confirmation.md) | Stakeholder direction, 2026-08-14; composition sign-in rule, 2026-09-16 | A Customer can complete each listed outcome in a new browser context without a Customer account, while any unconfirmed context remains distinguishable from a customer record. | not assigned | accepted |
...
| FR-017 | Accepted Staff detail views SHALL expose positive counts of distinct incoming records for Customer/traveller roles to Travel Orders, supplier roles to products, products to Inventory records, and StockItems to Travel Orders; zero counts SHALL be plain text. | VIEW-S-002–007 | Issue #49 Phase 1 stakeholder decision, 2026-09-01 | Each accepted relationship renders a count control only when its count is positive and navigates to the target view using its exact identifier filter. | high | proposed |
| FR-018 | The Automated Travel Advisor SHALL require a Customer to sign in before proposing or composing Individual Travel, while anonymous question answering, search, and travel-information review remain available. | [UC-001](use-cases/uc-001-seek-travel-advice.md), [UC-003](use-cases/uc-003-compose-individual-travel.md) | Stakeholder direction, 2026-09-16 | An unsigned Customer asking the advisor to plan, compose, or propose travel is asked to sign in before the composition operation is invoked; after successful sign-in the Customer returns to the advisor with the conversation context preserved. | high | accepted |
