...
|---|---|---|---|---|---|---|
| FR-001 | Customer, staff, and supplier interactions SHALL present user-facing content in British English. | [Customer Interaction, Staff Interaction, and Supplier Interaction](bounded-contexts/bounded-contexts.md) | Stakeholder direction, 2026-08-01; scope clarification, 2026-08-03 | Representative content in each interaction context conforms to British English spelling and usage. | not assigned | accepted |
| FR-002 | Customer, staff, and supplier interactions SHALL permit an additional interaction language to be introduced without changing domain rules or use-case definitions. | [Customer Interaction, Staff Interaction, and Supplier Interaction](bounded-contexts/bounded-contexts.md) | Stakeholder direction, 2026-08-01; scope clarification, 2026-08-03 | A representative interaction in each context can be presented in a synthetic second language while producing the same domain outcome as its British English version. | not assigned | accepted |
| FR-003 | Customer, staff, and supplier interactions SHALL be provided through web user interfaces. | [Customer Interaction, Staff Interaction, and Supplier Interaction](bounded-contexts/bounded-contexts.md) | Stakeholder direction, 2026-08-01; scope clarification, 2026-08-03 | Every supported interaction in the three interaction contexts can be completed through a web browser. | not assigned | accepted |
