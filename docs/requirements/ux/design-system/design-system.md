...
| 2026-08-21 | Extended DS-CMP-007 with the staff portal's reusable URL-state and native browser-history contract. The product catalogue is the first implementation because it exercises filters, paging, selection, and related-product hyperlinks together. | Issue #51; automated URL round-trip and navigation tests; human implementation review pending before commit |
