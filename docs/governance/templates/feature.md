...
Link exactly one epic parent and exactly one use case within that epic's domain. Link relevant source evidence and accepted requirement IDs; classify unsupported statements as assumptions or proposals.
