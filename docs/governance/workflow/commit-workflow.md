# Engineering and Commit Workflow
...
Do not mix unrelated cleanup with product behavior. Do not claim tests or reviews that did not run. Technology-specific branching, formatting, linting, testing, and commit-message rules will be added only after the stack and delivery platform are selected.
