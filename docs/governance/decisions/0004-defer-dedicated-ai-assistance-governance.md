# ADR-0004: Defer dedicated AI-assistance governance

- Status: accepted
- Date: 2026-07-27
- Deciders: project owner and engineering
- Supersedes: ADR-0003 in part

## Context

ADR-0003 placed a draft AI-assistance policy in a dedicated Governance subtheme. The project does not currently need a separate authoritative area for this material, and retaining an unclear subtheme would work against the goal of a compact documentation structure.
