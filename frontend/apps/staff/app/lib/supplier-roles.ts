...
/** The `partner/supplier/*` role types entity-model terminology TERM-002 currently defines. `partner/supplier/hotel` was removed as an unused duplicate of `partner/supplier/accommodation` (naming-consistency cleanup). No generic non-supplier `partner/partner` type exists yet (WF-Q-012). */
