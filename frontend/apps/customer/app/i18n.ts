...
export const dictionary: Record<string, string> = {
  ...
  "travel.removeProduct": "Remove product",
  "travel.picker.label": "Choose dates and travellers",
  "travel.picker.show": "Choose dates and travellers",
  "travel.picker.hide": "Hide dates and travellers",
  "travel.picker.date": "Date",
  "travel.picker.empty": "No dates are available for this product.",
  "travel.picker.saveTraveller": "Save traveller",
  "travel.picker.error": "This selection could not be added. Please try again.",
  "travel.picker.combinations": "date/traveller combinations",
